...
"C:\Program Files\Oracle\VirtualBox\VBoxManage.exe" modifyvm "C:\Users\mxwke\VirtualBox VMs\archtest\archtest.vbox" --firmware efi --nic1 bridged --bridgeadapter1 "Intel(R) Wireless-AC 9560 160MHz"
